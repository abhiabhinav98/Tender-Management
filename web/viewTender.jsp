...
<%@page import="org.websparrow.controller.UserLoginController"%>
	  ...
	  <tr><th>Tender ID</th><th>Tender Name</th><th>Opening Date</th><th>Closing Date</th><th>Minimum Bid</th><th>Tender Description</th><th>Publisher</th><th>Edit</th><th>Delete</th></tr>  
	  
	  <c:forEach var="row" items="${tenderAll}">
	  <tr>
	  <td>${row.tId}</td>
	  <td>${row.tName}</td>
	  <td>${row.opening}</td>
	  ...
	  <td>${row.publisher}</td>
	  <td><a href="#">Edit</a></td>
	  <td><a href="deleteTenderByAdmin/${row.tId}">Delete</a></td>			
	  </tr>
	  </c:forEach>
	  </table>
	  <br/>
