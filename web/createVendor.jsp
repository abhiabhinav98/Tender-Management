...
<div class="container">
  <div class="login">
    <h1>Create Vendor</h1>
    <form method="post" action="createVendor">
      <p><input type="text" name="vname" placeholder="Vendor Name" required></p>
      
      <p><input type="text" name="address" placeholder="Vendor's Address" required></p>
      <p><input type="text" name="phone" placeholder="Vendor's Phone Number(s)" required></p>
      <p><input type="email" name="email" placeholder="Vendor's Email Address" required></p>
      <p><input type="password" name="password" placeholder="Vendor's Password" required></p>
