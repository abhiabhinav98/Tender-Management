...
<div class="container">
  <div class="login">
    ...
    <form method="post" action="createUser">
      <p><input type="text" name="uname" placeholder="User's Name" required></p>
      
      <p><input type="text" name="department" placeholder="User's Address" required></p>
      <p><input type="text" name="phone" placeholder="User's Phone Number(s)" required></p>
      <p><input type="email" name="email" placeholder="User's Email Address" required></p>
      <p><input type="password" name="password" placeholder="User's Password" required></p>
