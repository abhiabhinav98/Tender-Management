...
<header style=background-color:black;width:100%;height:60px;color:red;><center><h1>Tender Management</h1></center></header>
<nav class="navbar" style="background-color:black;margin-top:10px;">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="vendorLogin.jsp">Login as Vendor.</a></li>
    </ul>
  </div>
</nav>
<div class="container">
  <div class="login">
    ...
    <form method="post" action="login">
      <p><input type="text" name="userId" placeholder="Username" required></p>
      <p><input type="password" name="password" placeholder="Password" required></p>
      <p class="remember_me">
        <input type="checkbox" name="remember_me" id="remember_me" checked>
        <label for="remember_me"><span class="box"></span>Remember me on this computer</label>
        </p>
