...
<%@page import="org.websparrow.model.tender"%>
<%@page import="java.util.List"%>
<%@page import="org.websparrow.dao.UserDaoImpl"%>
<%@page import="org.websparrow.controller.UserLoginController"%>

	          <h1>Place Your Bid</h1>  
       <form:form method="POST" action="/spring-mvc-user-reg-login/placeMyBid">    
        <table >    
        <tr>  
        <td>Tender Id</td>    
         <td><form:input  path="tId" readonly/></td>  
         </tr>   
         <tr>    
          <td>Tender Name : </td>   
          <td><form:input path="tName" readonly/></td>  
         </tr>    
         <tr>    
          <td>Opening Date :</td>    
          <td><form:input type="date" path="opening" readonly/></td>  
         </tr>   
         <tr>    
          <td>Closing Date :</td>    
          <td><form:input type="date" path="closing" readonly/></td>  
         </tr>  
         <tr>    
          <td>Minimum Bid :</td>    
          <td><form:input path="minBid" readonly/></td>  
         </tr> 
           <tr>    
          <td>Tender Description :</td>    
          <td><form:input path="tDesc" readonly/></td>  
         </tr>
         <tr>    
          <td>My Bid :</td>    
          <td><form:input path="myBid" min="minBid" /></td>  
         </tr>
         <tr>    
          <td> </td>    
        ...
        <td></td>    
         <td><form:hidden  path="publisher" /></td>  
         </tr>  
        </table>    
       </form:form>  
