...
<%@page import="org.websparrow.dao.vendorDAO"%>
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%>
	  ...
	  <tr><th>Tender ID</th><th>Tender Name</th><th>Opening Date</th><th>Closing Date</th><th>Minimum Bid</th><th>Tender Description</th><th>Publisher</th><th colspan=3>Bid</th></tr>  
	  
	  <c:forEach var="row" items="${tenders}">
	  <tr>
	  <td>${row.tId}</td>
	  <td>${row.tName}</td>
	  <td>${row.opening}</td>
	  ...
	  <td>${row.tDesc}</td>
	  <td>${row.publisher}</td>
	  <td><a href="place/${row.tId }">Place Bid</a></td>
	  </tr>
	  </c:forEach>
	  </table>
	  <br/>
