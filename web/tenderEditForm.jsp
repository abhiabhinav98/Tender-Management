...
<%@page import="org.websparrow.controller.UserLoginController"%>
	          ...
	          <h1>Edit Tender</h1>  
       <form:form method="POST" action="/spring-mvc-user-reg-login/editsave">    
        <table >    
        <tr>  
        <td></td>    
         ...
         <tr>    
          <td>Opening Date :</td>    
          <td><form:input type="date" path="opening" /></td>  
         </tr>   
         <tr>    
          <td>Closing Date :</td>    
          <td><form:input type="date" path="closing" /></td>  
         </tr>  
         <tr>    
          <td>Minimum Bid :</td>    
          <td><form:input path="minBid" /></td>  
         </tr> 
           <tr>    
          <td>Tender Description :</td>    
          <td><form:input path="tDesc" /></td>  
         </tr>
         <tr>    
          <td> </td>    
